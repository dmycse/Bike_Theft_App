...
import { fetchTheftRecords, fetchTheftRemove, status, bikeType, bikeColor } from 'components/store/theftSlice';
...
function TheftsRecords() {
	...
	return (
		<article className={css.theftrecords}>
			...
			<Button 
				type='button'
				label='Coздать сообщение о краже'
				className={css.theftrecords__btn}
				onClick={goTo}
			/>
